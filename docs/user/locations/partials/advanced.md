Er zijn een aantal belangrijke instellingen beschikbaar om de logica en het gedrag van bloklocaties verder af te stemmen:

- **Aantal zitplaatsen**: Het standaard aantal beschikbare plaatsen op de locatie. Je kunt dit later per tijdsblok of openingstijd overschrijven, bijvoorbeeld als een specifiek lokaal op een bepaalde dag niet beschikbaar is of er stoelen bijgeplaatst worden.
